                            ...
                            <TableContainer component={Paper} key={item.invoiceItemId}>
                                <Table>
                                    ...
                                    <TableBody>
                                        ...
                                        <TableRow>
                                            <TableCell style={{ fontWeight: "bold", textAlign: "left", borderRight: "2px solid black", display: "flex", alignItems: "center" }}>
                                                {item.edgeProfile.edgeProfileMeasurement} {item.material}&nbsp;Loc:
                                                &nbsp;
                                                <TextField

                                                    id="standard-basic"
                                                    sx={{
                                                        input: { color: 'black', width: '100px', height: '30px' }
                                                    }}
                                                    type="text"
                                                />
                                            </TableCell>
